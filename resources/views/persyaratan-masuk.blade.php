...
<head>
        <title>Administrasi Bisnis Pascasarjana - Persyaratan Masuk</title>
        <meta charset="utf-8">
    ...
    <body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="">
        ...
        <header class="header-with-topbar">
            <div class="header-top-bar top-bar-dark cover-background" style="background-color: #800000; padding-top: 10px; padding-bottom: 10px;">
                ...
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden"
                    ...
                    <div class="card-body p-4">
                        ...
                        data-anime='{ "opacity": [0,1], "translateY": [20, 0], "duration": 600, "delay":400, "easing": "easeOutQuad" }'>
                            Untuk dapat diterima sebagai mahasiswa Program Studi Administrasi Bisnis Pascasarjana di Universitas Wanita Internasional, calon mahasiswa harus memenuhi persyaratan sebagai berikut:
                        </p>
